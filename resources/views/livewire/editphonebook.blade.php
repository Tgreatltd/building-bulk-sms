    ...
    <div class="max-w-md mx-auto bg-white p-6 rounded shadow-md">
        ...
        <form > <!-- Replace 'update.route' with your actual update route -->
            ...
            <div class="mb-4">
                ...
                <input disabled type="text" id="input1" wire:model='id' value="{{$used->id}}" class="border rounded w-full py-2 px-3 focus:outline-none focus:border-blue-400">
            </div>
            <div class="mb-4">
                <label for="input2" class="block text-gray-600">NAME</label>
                <input type="text" id="input2" wire:model='name' value="{{$used->name}}" class="border rounded w-full py-2 px-3 focus:outline-none focus:border-blue-400">
            </div>
            <div class="mb-4">
                <label for="input3" class="block text-gray-600">NUMBERS</label>
                <input type="text" id="input3"  wire:model='numbers' value="{{$used->number}}" class="border rounded w-full py-2 px-3 focus:outline-none focus:border-blue-400">
            </div>
